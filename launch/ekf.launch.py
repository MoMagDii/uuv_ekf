...
def generate_launch_description():
    return LaunchDescription([
        launch_ros.actions.Node(
            package='uuv_ekf', executable='uuv_ekf', output='screen', name='controller_node',
            parameters=[
                get_package_share_directory(
                    'uuuv_ekf') + '/params/ekf_rexrov.yaml']
        """    
        launch_ros.actions.Node(
            ...
            arguments=['0.06593', '-0.006', '-0.13673', '0', '1.57', '0',
                       'rexrov/base_link', 'rexrov/dvl_link']),
        launch_ros.actions.Node(
            # IMU
            package='tf2_ros', executable='static_transform_publisher',
            arguments=['0.02407', '-0.16119', '0.05839', '0', '0.0', '0',
                       'rexrov/base_link', 'rexrov/imu_link']),
        launch_ros.actions.Node(
            # Pressure sensor
            package='tf2_ros', executable='static_transform_publisher',
            arguments=['-0.08048', '-0.01294', '0.06524', '0', '0.0', '0',
                       'rexrov/base_link', 'rexrov/pressure_link'])
        """               
    ])
